...
class StreamBase(BaseModel):
    ...
    camera_tilt_deg: float = Field(default=15.0, ge=-45.0, le=89.0)
    camera_height_m: float = Field(default=4.0, ge=0.5, le=120.0)
...
class StreamUpdate(BaseModel):
    ...
    camera_tilt_deg: Optional[float] = Field(default=None, ge=-45.0, le=89.0)
    camera_height_m: Optional[float] = Field(default=None, ge=0.5, le=120.0)
